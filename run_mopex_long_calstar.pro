function run_mopex_long_calstar, directory_name, mopex_script_env, namelist_ch1, namelist_ch2, framtime
print, 'directory_name', directory_name

full_name = directory_name  ;full directory path to calaor
;calaor= strmid(directory_name, 49)  ;cal aor name
directory_name = strmid(directory_name,0,37) ;path just to 016300
...
command8 = 'cat ' + directory_name + '/ch1_bcd_test.list | grep -v 0000.0000  | grep  002 | grep -v flat > ' + directory_name+'/ch1_bcd_good.list'  ;| grep  002
command9 = 'cat ' + directory_name + '/ch1_bunc_test.list | grep -v 0000.0000  | grep  002  > ' + directory_name+'/ch1_bunc_good.list'  ;| grep  002
command10 = 'cat ' + directory_name + '/ch1_bimsk_test.list | grep -v 0000.0000 | grep  002 > ' + directory_name+'/ch1_bimsk_good.list' ;| grep  002
command11 = 'cat ' + directory_name + '/ch2_bcd_test.list | grep -v 0000.0000 | grep  004 | grep -v flat > ' + directory_name+'/ch2_bcd_good.list' ;| grep  004
command12 = 'cat ' + directory_name + '/ch2_bunc_test.list | grep -v 0000.0000 | grep  004 > ' + directory_name+'/ch2_bunc_good.list';| grep  004
command13 = 'cat ' + directory_name + '/ch2_bimsk_test.list | grep -v 0000.0000 | grep  004 > ' + directory_name+'/ch2_bimsk_good.list';| grep  004

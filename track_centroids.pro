...
;angle for all warm mission long stares
  COMMON centroid_block, pid, campaign_name, start_jd, aorname, preaor, prera, predec, prejd, prepid, spitzer_jd, ra_string, dec_string,  naxis, xarr, yarr,xunc, yunc, fluxarr, fluxerrarr, corrfluxarr, corrfluxerrarr, bmjd_0, timearr, bmjd,  backarr, backerrarr, npcentroidsarr, exptime, xfwhmarr, yfwhmarr, fdarr, corrflux_d, datacollect36, datacollect45, piarr, pre36, pre45, premin_dur, planethash, ra, dec, startnaor, min_dur, ra_rqst, dec_rqst, start_year
 ...
 ;; print, string(n_elements(aorname)),  ' aors: ',  aorname
  ...
  chname = ['ch1','ch2']
  for na =startnaor,1000 do begin ; n_elements(aorname) -1 do begin
...
;;              print,na, 'pid at end', pid[na]
              ...
              planethash[aorname(na)] = dictionary(keys, values)
              savename =  '/Users/jkrick/Library/Mobile Documents/com~apple~CloudDocs/track_centroids_5.sav'

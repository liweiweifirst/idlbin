pro pcrs_lightcurve
  ...
  dirloc = '/Users/jkrick/irac_warm/pcrsstare'
  cd, dirloc
  
  command1  =  "find . -name '*bcd_fp.fits' > bcdlist.txt"
  spawn, command1
  
  readcol,'bcdlist.txt', fitsname, format = 'A', /silent
  numoobjects = n_elements(fitsname)     
  ...
  save, calstar, filename='/Users/jkrick/irac_warm/pcrsstare/pixnoise.sav'
;help, calstar

pro rastr,pixel,res,face,sixpack,data,raster,x_out,y_out,bad_pixval
;+NAME/ONE LINE DESCRIPTION OF ROUTINE:
;    RASTR generates rasterized images
;
;DESCRIPTION:
;    This IDL procedure is called by PIX2XY to create a raster image
;
;CALLING SEQUENCE:
;    rastr,pixel,res,face,sixpack,data,raster,x_out,y_out,bad_pixval
;
...
;
; SPR 10643  Mar 2, 1993  J.M. Gales
; Change name to 'RASTR'
;

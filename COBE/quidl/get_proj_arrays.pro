FUNCTION get_proj_arrays, proj_type,coord_type,psize,i_arr,j_arr,mask
;+NAME/ONE LINE DESCRIPTION OF ROUTINE:
;    get_proj_arrays reads in projection lookup arrays
;
;DESCRIPTION:
...
;
;CALLING SEQUENCE:
;    get_proj_arrays, proj_type,coord_type,psize,i_arr,j_arr,mask
;
...
COMMON last, last_l, last_h, last_proj, last_flag
...
IF ((psize EQ 'L' OR psize EQ '+') $
    AND ((proj_type EQ 'S') OR (coord_type EQ 'Q'))) THEN BEGIN

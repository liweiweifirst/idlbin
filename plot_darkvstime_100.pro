pro plot_darkvstime
ps_open, filename='/Users/jkrick/irac_darks/darksvstime_cryo_100.ps',/portrait,/square,/color
...
restore, filename = '/Users/jkrick/irac_darks/cryodarks_100_1.sav'
...
restore, filename = '/Users/jkrick/irac_darks/cryodarks_100_2.sav'
...
;zodi from header not removed from the data
restore, filename = '/Users/jkrick/irac_darks/alldarks_100_4.sav'
...
;zodi in the header has been subtracted 
restore, filename = '/Users/jkrick/irac_darks/alldarks_100_3.sav'
;-------------------------------------------------------------------
...
plot, (ch1_sclksort_all - ch1_sclksort_all(0)) / 86400 / 365, ch1_meansort_all, psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 1 F100s', yrange = [0.03, 0.1], ystyle = 1
...
;-----
plot, (ch2_sclksort_all - ch2_sclksort_all(0)) / 86400 / 365, ch2_meansort_all ,  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 2 F100s', yrange = [0.0,0.4], ystyle = 1
...
plot, (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort ,  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 3 F100s', yrange = [-4.0,2.0], ystyle = 1, xrange = [0,8]
...
plot, (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort ,  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 4 F100s', yrange = [-1.0,8.0], ystyle = 1, xrange = [0,8]
...
plot, (ch1_sclksort_all - ch1_sclksort_all(0)) / 86400 / 365, ch1_meansort_all - mean(ch1_meansort_all), psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 1 F100s', yrange = [-0.02, 0.02], ystyle = 1
oplot, (nozodi_ch1_sclksort_all - nozodi_ch1_sclksort_all(0)) / 86400 / 365, nozodi_ch1_meansort_all - nozodi_ch1_meansort_all, psym = 4

;-----
plot, (ch2_sclksort_all - ch2_sclksort_all(0)) / 86400 / 365, ch2_meansort_all - mean(ch2_meansort_all) ,  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 2 F100s', yrange = [-0.1,0.1], ystyle = 1
...
plot, (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort - mean(cryo_ch3_meansort),  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 3 F100s', yrange = [-0.5,0.5], ystyle = 1, xrange = [0,8]
...
plot, (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort - mean(cryo_ch4_meansort),  psym = 2, ytitle = 'Mean flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 4 F100s', yrange = [-1.5,1.5], ystyle = 1, xrange = [0,8]
...
plot, (ch1_sclksort_all - ch1_sclksort_all(0)) / 86400 / 365, ch1_meansort_all/ ch1_meansort_all(0) , psym = 2, ytitle = 'Normalized flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 1 F100s', yrange = [0.5,1.5]
...
plot, (ch2_sclksort_all - ch2_sclksort_all(0)) / 86400 / 365, ch2_meansort_all / ch2_meansort_all(0),  psym = 2, ytitle = 'Normalized flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 2 F100s', yrange = [0.8,1.8], ystyle = 1
...
plot, (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort / cryo_ch3_meansort(0),  psym = 2, ytitle = 'Normalized flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 3 F100s', yrange = [-1.5,2.5], ystyle = 1, xrange = [0,8]
...
plot, (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort / cryo_ch4_meansort(0),  psym = 2, ytitle = 'Normalized flux', xtitle = 'Time in years starting from Dec 01 2003', title = 'Channel 4 F100s', yrange = [-2.0,2.0], xrange = [0,8]

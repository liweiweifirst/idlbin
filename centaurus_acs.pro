...
for ch = 0, 2 do begin          ;for 435,606,814
   if ch eq 0 then begin
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs435_drz.fits', exten_no = 1, data, header
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs435_drz.fits', exten_no = 2 ,rrdata, rrheader
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs435_segmentation.fits', segdata, segheader
      zpt = 25.68392 ;http://www.stsci.edu/hst/acs/analysis/zeropoints
      photflam = fxpar(header, 'PHOTFLAM')
      A_lambda = .481 ;galactic extinction in mags
      print, '****F435*****'
   endif

   if ch eq 1 then begin
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs606_drz.fits', exten_no = 1, data, header
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs606_drz.fits', exten_no = 2 ,rrdata, rrheader
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs606_segmentation.fits', segdata, segheader
      zpt = 26.50512
      photflam = fxpar(header, 'PHOTFLAM')
      A_lambda = .333 ;galactic extinction in mags
      print, '****F606*****'
   endif
   if ch eq 2 then begin
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs814_drz.fits', exten_no = 1, data, header
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs814_drz.fits', exten_no = 2 ,rrdata, rrheader
      fits_read, '/Users/jkrick/plumes/centaurus/hst/acs814_segmentation.fits', segdata, segheader
      zpt = 25.95928
      photflam = fxpar(header, 'PHOTFLAM')
      A_lambda = .222 ;galactic extinction in mags
      print, '****F814*****'
   endif
...
;roi photometry
   ...
   naxis2 = fxpar(header, 'naxis2')
                                ...
                                ;in ra and dec 
   raroi1 = [192.48716,192.41136,192.40174,192.47732]
   decroi1 = [-41.433178,-41.396596,-41.400027,-41.43696]
...
;since there is not much background, will need to specifically choose the background regions.
   rabkg1=[192.4583,192.43997,192.42576,192.44822]
   decbkg1=[-41.430265,-41.422192,-41.44864,-41.442288]
   rabkg2=[192.43654,192.40769,192.41867,192.42508]
   decbkg2=[-41.420646,-41.406212,-41.428544,-41.443659]

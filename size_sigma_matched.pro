...
ps_start, filename= '/Users/jkrick/Virgo/IRAC/test2_size_sigma_ch2.ps'
!P.multi = [0,1,1]
...
;first use the segmentation image from both channels as a mask
   fits_read, '/Users/jkrick/Virgo/IRAC/ch1/ch1_Combine-mosaic/segmentation.fits', segdata1, segheader1
   fits_read, '/Users/jkrick/Virgo//IRAC/ch2/ch2_Combine-mosaic/segmentation.fits', segdata2, segheader2

   segmask1 = where(segdata1 gt 0)
   segmask2 = where(segdata2 gt 0)
   ;data(segmask1) = nan
   data(segmask2) = nan

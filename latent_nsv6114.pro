...
;read in the flats for later
  ...
  dir_name = ['/Users/jkrick/irac_pc/pc2/IRAC022300/bcd/0037274880']
  ...
  bcdlist = bcdch2list; bcdch1list  

  ;only want certain images not contaminated by the bright star
  ;a = [19,21,23,25,27,31,33,35,37,39,41,43,45,47]  ;ch1
  a = [15,17,19,21,23,25,27,31,35]  ;ch1
  bcdlist = bcdlist(a)
...
;oplot, xarr, .0113*exp(-(xarr)/(-.0747)), linestyle = 1
; oplot, xarr, .078825*exp(-(xarr)/(-1.13909)), linestyle = 2
...
save, filename = '/Users/jkrick/iwic/latent_nsv6114_ch2.sav', time, flux
end

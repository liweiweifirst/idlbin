...
dec_ref = 21.894722
  ...
  for a = 0, n_elements(aorname) - 1 do begin
     ...
     command  =  "find ch1/bcd -name '*_bcd.fits' > /Users/jkrick/irac_warm/pcrs_planets/wasp14/bcdlist.txt"
     spawn, command
     command2 =  "find  ch1/bcd -name '*bunc.fits' > /Users/jkrick/irac_warm/pcrs_planets/wasp14/bunclist.txt"
     spawn, command2
...
;        file_suffix = ['500x500_0043_120828.fits','0p1s_x4_500x500_0043_120531.fits']
        ;corrflux = iracpc_pmap_corr(abcdflux, x_center, y_center, 2, /threshold_occ, threshold_val = 20)
        corrflux = iracpc_pmap_corr(abcdflux,x_center,y_center,1,FILE_SUFFIX=file_suffix,/threshold_occ, threshold_val = 20)
 ...
 ;--------------------------------
  ...
  save, AORwasp14, filename='/Users/jkrick/irac_warm/pcrs_planets/wasp14/wasp14_phot_ch1.sav'
  undefine, AORwasp14
...
;save, /all, filename = '/Users/jkrick/irac_warm/pcrs_planets/wasp33/wasp33_phot_ch1.sav'
end

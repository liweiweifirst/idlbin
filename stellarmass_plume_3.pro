...
;restore, '/Users/jkrick/nutella/idlbin/objectnew.sav'        ;object
  restore,'/Users/jkrick/nutella/bin/bc03/bc03_2.sav' ;model
  restore,'/Users/jkrick/nutella/bin/bc03/lambda_2.sav' ;lambda
  
  restore, '/Users/jkrick/nutella/maraston/model.2.sav' ;mmodel
  restore, '/Users/jkrick/nutella/maraston/lambda.sav'  ;mlambda
  restore, '/Users/jkrick/nutella/maraston/age.sav'     ;age
  
  
  print,"started at "+systime()
  
  readcol,'/Users/jkrick/nutella/bin/bc03/filelist_2',filename,format="A",/silent
...
;bc03
    ...
    plot, findgen(10), findgen(10), xrange = [13, 17], yrange = [0.5, 1.2], /nodata, xtitle = '3.6 (AB)', ytitle = 'B - V (AB)'
...
;       print, 'ch1arr', ch1arr
       ...
       for a = start, 5E8, size do begin
          b = where(massarr eq a)
          print, 'mass', massarr(b)
          print, 'ch1arr(b)', ch1arr(b)
          oplot, ch1arr(b), barr(b)-varr(b)
          xyouts, ch1arr(b(8)), barr(b(8)) - varr(b(8)),   string(a, format = '(E10.1)'), orientation = 45
...
;          modelname =  strmid(filename(m), 65,19) + string(bc03age(bcnj))
          ...
          if a eq 1.0E9 then begin
             xyouts, ch1arr(b) - 0.05, barr(b) - varr(b) - 0.008, string(fix(bc03age)) + 'Gyr'
          endif
...
xerr = 0.5; (making this up)
y_bv = 0.9
yerr = 0.15

oploterror, x_ch1,y_bv, xerr, yerr, errthick = 3, psym = 2

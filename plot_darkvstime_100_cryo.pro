...
print, 'cryo_ch4_meansort', cryo_ch4_meansort
...
;-------------------------------------------------------------------
;begin the plotting
z = pp_multiplot(multi_layout=[1, 4], global_xtitle='Time in Years Starting from Dec 01 2003',global_ytitle='Mean Flux (MJy/sr)')
...
mp=z.errorplot( (cryo_ch1_sclksort - cryo_ch1_sclksort(0)) / 86400 / 365, cryo_ch1_meansort, cryo_ch1_sigmasort, errorbar_color = 'red', linestyle = 6, multi_index = 0,/overplot)
...
mp = z.errorplot((cryo_nozodi_ch1_sclksort - cryo_nozodi_ch1_sclksort(0)) / 86400 / 365, cryo_nozodi_ch1_meansort, cryo_nozodi_ch1_sigmasort, /overplot, multi_index = 0, errorbar_color = 'blue', linestyle = 6)
;-----
...
mp = z.errorplot( (cryo_ch2_sclksort - cryo_ch2_sclksort(0)) / 86400 / 365, cryo_ch2_meansort ,cryo_ch2_sigmasort,errorbar_color = 'red', linestyle = 6, multi_index = 1,  /overplot)
...
mp = z.errorplot( (cryo_nozodi_ch2_sclksort - cryo_nozodi_ch2_sclksort(0)) / 86400 / 365, cryo_nozodi_ch2_meansort, cryo_nozodi_ch2_sigmasort, /overplot, multi_index = 1,errorbar_color = 'blue', linestyle = 6)
;-------------------------------------------------------
...
mp = z.errorplot( (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort ,  cryo_ch3_sigmasort, errorbar_color = 'red', linestyle = 6,multi_index = 2,/overplot)
...
mp = z.errorplot( (cryo_nozodi_ch3_sclksort - cryo_nozodi_ch3_sclksort(0)) / 86400 / 365, cryo_nozodi_ch3_meansort,cryo_nozodi_ch3_sigmasort,errorbar_color = 'blue', linestyle = 6, /overplot , multi_index = 2)
;-----
...
mp = z.errorplot( (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort , cryo_ch4_sigmasort ,  errorbar_color = 'red', linestyle = 6,multi_index = 3,/overplot)
...
mp = z.errorplot( (cryo_nozodi_ch4_sclksort - cryo_nozodi_ch4_sclksort(0)) / 86400 / 365, cryo_nozodi_ch4_meansort,cryo_nozodi_ch4_sigmasort, errorbar_color = 'blue', linestyle = 6,/overplot , multi_index = 3)


;-------------------------------------------------------------------
;-------------------------------------------------------------------
;plot the mean levels with means subtracted.
z2 = pp_multiplot(multi_layout=[1, 4], global_xtitle='Time in Years Starting from Dec 01 2003',global_ytitle='Mean Subtracted Flux (MJy/sr)')
...
sp = z2.errorplot( (cryo_ch1_sclksort - cryo_ch1_sclksort(0)) / 86400 / 365, cryo_ch1_meansort - mean(cryo_ch1_meansort),cryo_ch1_sigmasort,  errorbar_color = 'red', linestyle = 6, multi_index = 0,/overplot)
...
sp = z2.errorplot( (cryo_nozodi_ch1_sclksort - cryo_nozodi_ch1_sclksort(0)) / 86400 / 365, cryo_nozodi_ch1_meansort - mean(cryo_nozodi_ch1_meansort),cryo_nozodi_ch1_sigmasort,  errorbar_color = 'blue', linestyle = 6,  multi_index = 0,/overplot)
;-----
...
sp = z2.errorplot( (cryo_ch2_sclksort - cryo_ch2_sclksort(0)) / 86400 / 365, cryo_ch2_meansort - mean(cryo_ch2_meansort) ,cryo_ch2_sigmasort,  errorbar_color = 'red', linestyle = 6 ,multi_index = 1,/overplot)
...
sp = z2.errorplot( (cryo_nozodi_ch2_sclksort - cryo_nozodi_ch2_sclksort(0)) / 86400 / 365, cryo_nozodi_ch2_meansort - mean(cryo_nozodi_ch2_meansort), cryo_nozodi_ch2_sigmasort ,  errorbar_color = 'blue', linestyle = 6, multi_index = 1,/overplot)
;-----
...
sp = z2.errorplot( (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort - mean(cryo_ch3_meansort), cryo_ch3_sigmasort,  errorbar_color = 'red', linestyle = 6, multi_index = 2,/overplot)
...
sp = z2.errorplot( (cryo_nozodi_ch3_sclksort - cryo_nozodi_ch3_sclksort(0)) / 86400 / 365, cryo_nozodi_ch3_meansort - mean(cryo_nozodi_ch3_meansort),cryo_nozodi_ch3_sigmasort,  errorbar_color = 'blue', linestyle = 6, multi_index = 2,/overplot)
;-----
...
sp = z2.errorplot( (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort - mean(cryo_ch4_meansort), cryo_ch4_sigmasort,  errorbar_color = 'red', linestyle = 6, multi_index = 3,/overplot)
...
sp = z2.errorplot( (cryo_nozodi_ch4_sclksort - cryo_nozodi_ch4_sclksort(0)) / 86400 / 365, cryo_nozodi_ch4_meansort - mean(cryo_nozodi_ch4_meansort) ,cryo_nozodi_ch4_sigmasort,  errorbar_color = 'blue', linestyle = 6,  multi_index = 3,/overplot)
...
np = z3.errorplot( (cryo_ch1_sclksort - cryo_ch1_sclksort(0)) / 86400 / 365, cryo_ch1_meansort/ cryo_ch1_meansort(0), cryo_ch1_sigmasort/ cryo_ch1_meansort(0), errorbar_color = 'red', linestyle = 6,multi_index = 0,/overplot)
...
np=z3.errorplot( (cryo_nozodi_ch1_sclksort - cryo_nozodi_ch1_sclksort(0)) / 86400 / 365, cryo_nozodi_ch1_meansort/ cryo_nozodi_ch1_meansort(0) ,cryo_nozodi_ch1_sigmasort/ cryo_nozodi_ch1_meansort(0) ,errorbar_color = 'blue', linestyle = 6,multi_index = 0,/overplot)
...
np=z3.errorplot( (cryo_ch2_sclksort - cryo_ch2_sclksort(0)) / 86400 / 365, cryo_ch2_meansort / cryo_ch2_meansort(0), cryo_ch2_sigmasort / cryo_ch2_meansort(0), errorbar_color = 'red', linestyle = 6,multi_index = 1,/overplot)
...
np=z3.errorplot( (cryo_nozodi_ch2_sclksort - cryo_nozodi_ch2_sclksort(0)) / 86400 / 365, cryo_nozodi_ch2_meansort / cryo_nozodi_ch2_meansort(0),cryo_nozodi_ch2_sigmasort / cryo_nozodi_ch2_meansort(0), errorbar_color = 'blue', linestyle = 6,multi_index = 1,/overplot)
...
np=z3.errorplot( (cryo_ch3_sclksort - cryo_ch3_sclksort(0)) / 86400 / 365, cryo_ch3_meansort / cryo_ch3_meansort(0),  cryo_ch3_sigmasort / cryo_ch3_meansort(0), errorbar_color = 'red', linestyle = 6,multi_index = 2,/overplot)
...
np=z3.errorplot( (cryo_nozodi_ch3_sclksort - cryo_nozodi_ch3_sclksort(0)) / 86400 / 365, cryo_nozodi_ch3_meansort / cryo_nozodi_ch3_meansort(0),cryo_nozodi_ch3_sigmasort / cryo_nozodi_ch3_meansort(0),errorbar_color = 'blue', linestyle = 6,multi_index = 2,/overplot)
...
np=z3.errorplot( (cryo_ch4_sclksort - cryo_ch4_sclksort(0)) / 86400 / 365, cryo_ch4_meansort / cryo_ch4_meansort(0), cryo_ch4_sigmasort / cryo_ch4_meansort(0), errorbar_color = 'red', linestyle = 6,multi_index = 3,/overplot)
...
np=z3.errorplot( (cryo_nozodi_ch4_sclksort - cryo_nozodi_ch4_sclksort(0)) / 86400 / 365, cryo_nozodi_ch4_meansort / cryo_nozodi_ch4_meansort(0), cryo_nozodi_ch4_sigmasort / cryo_nozodi_ch4_meansort(0),errorbar_color = 'blue', linestyle = 6,multi_index = 3,/overplot)

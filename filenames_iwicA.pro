...
openw,88, strcompress(dir_name+ '/raw/' + 'rawlist_ch1_12s.txt')
openw,87, strcompress(dir_name+ '/raw/' +  'rawlist_ch1_6s.txt')
openw,86, strcompress(dir_name+ '/raw/' +  'rawlist_ch1_2s.txt')
openw,85, strcompress(dir_name+ '/raw/' + 'rawlist_ch1_0pt4s.txt')
openw,84, strcompress(dir_name+ '/raw/' + 'rawlist_ch1_0pt1s.txt')
openw,83, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_200s.txt')
openw,82, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_100s.txt')
openw,81, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_12s.txt')
openw,80, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_6s.txt')
openw,79, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_2s.txt')
openw,78, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_0pt4s.txt')
openw,77, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch1_0pt1s.txt')
openw,76, strcompress(dir_name+ '/raw/' + 'rawlist_ch2_200s.txt')
openw,75, strcompress(dir_name+ '/raw/' + 'rawlist_ch2_100s.txt')
openw,74, strcompress(dir_name+ '/raw/' + 'rawlist_ch2_12s.txt')
openw,73, strcompress(dir_name+ '/raw/' +  'rawlist_ch2_6s.txt')
openw,72, strcompress(dir_name+ '/raw/' +  'rawlist_ch2_2s.txt')
openw,71, strcompress(dir_name+ '/raw/' + 'rawlist_ch2_0pt4s.txt')
openw,70, strcompress(dir_name+ '/raw/' + 'rawlist_ch2_0pt1s.txt')
openw,69, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_200s.txt')
openw,68, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_100s.txt')
openw,67, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_12s.txt')
openw,66, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_6s.txt')
openw,65, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_2s.txt')
openw,64, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_0pt4s.txt')
openw,63, strcompress(dir_name+ '/bcd/' + 'bcdlist_ch2_0pt1s.txt')
...
;start with the raws
   ...
   for i = 0, count12 - 1 do begin
      ...
      printf, 88, strcompress(aorname(n) + strmid(list12(i),1))
   endfor
   ...
   for i = 0, count6 - 1 do begin
      ...
      printf, 87, strcompress(aorname(n) + strmid(list6(i),1))
   endfor
   ...
   for i = 0, count2 - 1 do begin
      ...
      printf, 86, strcompress(aorname(n) + strmid(list2(i),1))
   endfor
   ...
   for i = 0, count0pt4 - 1 do begin
      ...
      printf, 85, strcompress(aorname(n) + strmid(list0pt4(i),1))
   endfor
   ...
   for i = 0, count0pt1 - 1 do begin
      ...
      printf, 84, strcompress(aorname(n) + strmid(list0pt1(i),1))
   endfor

...
;  fits_read, '/Users/jkrick/idlbin/pmap_fits/pmap_ch2_0p1s_x4_500x500_0043_120124.fits', pmapdata, pmapheader
  ...
  restore, '/Users/jkrick/irac_warm/pcrs_planets/hd7924hd7924_phot_ch2.sav'
...
print, 'phase', AORhd7924[0].bmjdarr[0:100]
...
timearr = [AORhd7924[1].timearr]
fluxarr = [ AORhd7924[1].flux]
fluxerrarr = [ AORhd7924[1].fluxerr]
corrfluxarr = [ AORhd7924[1].corrflux]
corrfluxerrarr = [AORhd7924[1].corrfluxerr]
xarr = [ AORhd7924[1].xcen]
yarr = [AORhd7924[1].ycen]
bkgd = [ AORhd7924[1].bkgd]
bmjd = [ AORhd7924[1].bmjdarr]

print, 'n', n_elements(timearr), n_elements(AORhd7924[0].timearr), n_elements(AORhd7924[1].timearr)
;now for the binning
...
;     pl = errorplot((bin_timearr - bin_timearr(0))/60./60., bin_flux/median(bin_flux),bin_fluxerr, '6r1s', sym_size = 0.1,   sym_filled = 1, xrange = [0,9],  yrange = [0.99, 1.02], xtitle = 'Time (hrs)', ytitle = 'Normalized Flux', errorbar_capsize = 0.)
      ...
      pl = plot((bin_timearr - bin_timearr(0))/60./60., bin_flux/median(bin_flux), '6r1s', sym_size = 0.1,   sym_filled = 1,  xrange = [0,9],yrange = [0.98, 1.01], xtitle = 'Time (hrs)', ytitle = 'Normalized Flux', title = 'Wasp 13')

...
;Take out the first three images, mean together the rest of the 64 subimages 
    rmnum = 2.
    f1 = where(biashash[aorname(a),'framedelay'] ge 1.5 and biashash[aorname(a),'framedelay'] lt 1.82 and biashash[aorname(a), 'subimagenum'] gt rmnum, f1count)
    f2 = where(biashash[aorname(a),'framedelay'] ge 1.82 and biashash[aorname(a),'framedelay'] lt 1.9 and biashash[aorname(a), 'subimagenum'] gt rmnum, f2count)
...
;    mean0_f4 = (biashash[aorname(a), 'mean_0'])(f4)
    stddev0_f1 = (biashash[aorname(a), 'stddev_0'])(f1)
    stddev0_f2 = (biashash[aorname(a), 'stddev_0'])(f2)
    ...
    for j = 0, n_elements(framnumber_f2) - 1, (64 - rmnum - 1)  do begin
     ...
     print, 'n_ele', n_elements(bin_framnumber_f1), n_elements(bin_mean0_f1), n_elements(bin_stddev0_f1)
      pe = errorplot(bin_framnumber_f1, bin_mean0_f1, bin_stddev0_f1, '1s', sym_size = 0.5, $
                    sym_filled = 1, xtitle = 'Image number', ytitle = 'Mean Level (DN)', xrange = [0,650],yrange = [9.6, 12],$
...
;             title =titlename, sym_size = 0.3,   sym_filled = 1, xrange = [0,65], yrange = [118, 132]); yrange = [10, 11.5])
...
;    t = text(40, 120, 'framedly 1.5 - 1.6', color = 'black',/overplot,/data)
;        t = text(40, 121, 'framedly 1.6 - 1.7', color = 'blue',/overplot,/data)

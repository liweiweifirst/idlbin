pro phot_wasp39_ch2
  ...
  for a = 0, n_elements(aorname) - 1 do begin
     ...
     dir = '/Users/jkrick/irac_warm/pcrs_planets/wasp39/'+ string(aorname(a) ) 
     CD, dir                    ; change directories to the correct AOR directory
     command  =  "find ch2/bcd -name '*_bcd.fits' > /Users/jkrick/irac_warm/pcrs_planets/wasp39/cbcdlist.txt"
     spawn, command
     command2 =  "find  ch2/bcd -name '*bunc.fits' > /Users/jkrick/irac_warm/pcrs_planets/wasp39/bunclist.txt"
     spawn, command2

     readcol,'/Users/jkrick/irac_warm/pcrs_planets/wasp39/cbcdlist.txt',fitsname, format = 'A', /silent
     readcol,'/Users/jkrick/irac_warm/pcrs_planets/wasp39/bunclist.txt',buncname, format = 'A', /silent
...
;--------------------------------
 ...
 ;--------------------------------
    ...
    if n_elements(xarr) lt nfits then begin
       ...
       AORwasp39[a] ={wasp39ob,  ra_ref,dec_ref,xarr2,yarr2,fluxarr2,fluxerrarr2, corrfluxarr2, corrfluxerrarr2, sclk_0, timearr2,aorname(a),bmjd2, utcs2,back2, backerr2}
    endif else begin
       AORwasp39[a] ={wasp39ob,  ra_ref,dec_ref,xarr,yarr,fluxarr,fluxerrarr, corrfluxarr, corrfluxerrarr, sclk_0, timearr,aorname(a),bmjd,utcs,backarr, backerrarr}
    endelse

  endfor                        ;for each AOR
  
  ;test
  print, AORwasp39[0].ra, AORwasp39[0].xcen[26]
  
  save, AORwasp39, filename='/Users/jkrick/irac_warm/pcrs_planets/wasp39/wasp39_phot_ch2.sav'
  undefine, AORwasp39
...
;save, /all, filename = '/Users/jkrick/irac_warm/pcrs_planets/wasp39/wasp39_phot_ch2.sav'
end

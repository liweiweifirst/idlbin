...
y = y / 2.
p2 = plot(x, y/y(0), color = 'cyan', overplot = p2)
t = text(1E3, 0.6, 'GJ1214', color = 'cyan', /data)
...
p1 = plot(x, y/normfactor, color = 'cyan', overplot = p1)
t = text(1E3, 0.6, 'GJ1214', color = 'cyan', /data, target = p1)

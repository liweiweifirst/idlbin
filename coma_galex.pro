...
ps_open, filename='/Users/jkrick/plumes/coma/galex/background.ps',/portrait,/square,/color
...
for ch = 0, 1 do begin  ;for fuv and nuv
   if ch eq 0 then begin
      fits_read, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/AIS_113_sg87-fd-int.fits', data, header
      fits_read, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/AIS_113_sg87-fd-rrhr.fits', rrdata, rrheader
      zpt = 18.82
      flux_zpt = 1.4E-15
      explow = 125
      exphigh = 142
      binsize=0.00005
      AUV = 7.9*0.008 ;galactic extinction in mags
      lambda = 1516 ;angstroms
      print, '****FUV*****'
   endif

   if ch eq 1 then begin
      fits_read, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/AIS_113_sg87-nd-int.fits', data, header
      fits_read, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/AIS_113_sg87-nd-rrhr.fits', rrdata, rrheader
      zpt = 20.08 ;flux should be in photons per second
      flux_zpt = 2.06E-16
      explow = 105
      exphigh = 125
      binsize=0.0001
      AUV = 8.0*0.008  ; .008 from E(B-V) in schlegel maps
...
;roi photometry
  ...
  raroi1 = [194.88508,194.88382,194.86444,194.86583]
  decroi1 = [28.001283,28.006505,28.001841,27.995397]

  raroi2=[194.85086,194.8491,194.82494,194.82582]
  decroi2=[27.994286,27.998427,27.993394,27.989061]

  adxy, header, raroi1, decroi1, px1, py1
  adxy, header, raroi2, decroi2, px2, py2
...
;   if ch eq 0 then fits_write, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/fd_masked.fits', fuvdata, fuvheader
;   if ch eq 1 then fits_write, '/Users/jkrick/plumes/coma/galex/AIS_113_50113_0001_sv87/nd_masked.fits', fuvdata, fuvheader

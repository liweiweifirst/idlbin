...
!P.multi = [0,2,1]
readcol, '/Users/jkrick/iwic/dark_summary_08_18.csv', name,directory,reckey,date,exptime,fowler,waitper,nframes,channel,commandedK,corr_cernoxK,cernoxK,vreset,bias,vdduc,vgg1,new_mean,new_sigma,old_mean,old_sigma,old_noisy,noisypix,flux_conv,latent_strength,latent_decay,format='A,A,I, I, I, I, I,I,I,F10.2,F10.2,F10.2,F10.2,I,F10.2,F10.2,F10.2,F10.2,F10.2,F10.2,I, F10.5,F10.2,F10.5,F10.5'
...
plot,  x, y, psym = 2, xrange=[400,600], xtitle ='Bias',thick=3, charthick=3, xthick=3, ythick=3,$
      ytitle = 'Mean Noise Level (MJy/sr)', title = ' 12s', yrange=[0.03,.08]
oplot, x, y
...
legend, ['29.4K ', '31K', '32K '], psym = [2,4,6],/right,/top, thick=3, charthick=3
...
legend, ['29.4K ', '31K', '32K '], psym = [2,4,6],/left,/top, thick=3, charthick=3

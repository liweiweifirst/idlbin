...
Tc=56041.52887d
help, tc
p0_test=[2.24d0, 84.8d0*!dtor, 6.0d0, 0.280195, -0.0683042, Tc,  0.09421d0, 0.002115d0, 0.002367d0] ; for inc *!dtor
endif


p0_ramp=[0.00016d0, 0.07d0]
;initial fit from models
p0_phase=[[0.057d0, 1.0d0, 0.5d0, 0.5d0, 0.0001d0],$ ;flat

...
frametime = ['f0.4','h0.6','h0.6','h1.2','f2','h6','f12','h12']
ch1_pipeline_shift1 = [0.1,0.2,-0.01,0.06,1.5,1.3,0.3,0.04]
ch1_pipeline_shift2 = [2.8,2.5,2.8,1.1,2,2.5,1.7,2.3]
ch2_pipeline_shift1 = [1.3,-0.5,-0.7,2,2.4,2.1,-1.8,-1.8]
ch2_pipeline_shift2 = [5.6,3.7,3.5,4.7,9.7,11.6,5,4.8]

frametime = ['f0.4','h0.6','h0.6','h1.2','f2','h6','f12','h12']
ch2_predict_shift1 = [0.6,0.5,0.5,0.9,2.1,1.7,1.0,1.0]
ch2_predict_shift2 = [2.9,2.6,2.6,4.2,9.9,8.3,4.9,4.9]
ch1_predict_shift1 =[0.4,0.4,0.4,0.5,0.8,0.7,0.5,0.5]
ch1_predict_shift2 = [2.0,1.9,1.9,2.4,4.2,3.5,2.5,2.5]
...
;frametime =                      ['s0.02','s0.1','f0.4','s0.4','h0.6', 'h0.6',  'h1.2','f2','h6','f12','h12','f30','h30']
frametime = ['f0.4','h0.6','h0.6','h1.2','f2','h6','f12','h12']
ch1_pipeline_shift1_raw = [-0.1,    -0.1,  -0.007,0.02,1.5,1.0,  0.3, -0.3]
ch1_pipeline_shift2_raw = [1.8,       2.6 ,  1.58,  -.39,  2.1,1.6,  1.6, 1.9 ]
ch2_pipeline_shift1_raw = [0.5,      0.6 ,  0.66,    .77,  1.6,1.5,  0.9, 0.7 ]
ch2_pipeline_shift2_raw = [3.0,       3.5 ,  2.59,   4.45, 7.2,7.0,  4.0, 4.3 ]
...
ch1_shift1_obs_x = [0,5,6]
ch1_shift2_obs_y = [1.6]
ch1_shift2_obs_x = [0]

ch2_shift1_obs_y = [0.5, 6.3,2.3]
ch2_shift1_obs_x = [0,5,6]
ch2_shift2_obs_y = [2.7]
ch2_shift2_obs_x = [0]

frametime_ch1 = ['f0.4','h0.6','h0.6','h1.2','f2','h6','f12','h12']
x_ch1 = findgen(n_elements(frametime_ch1))
y_ch1 = [ch1_pipeline_shift2(0), ch1_pipeline_shift1(1), ch1_pipeline_shift2(2), ch1_pipeline_shift1(3), ch1_pipeline_shift2(4), ch1_pipeline_shift2(5),ch1_pipeline_shift1(6), ch1_pipeline_shift1(7) ]
frametime_ch2 = ['f0.4','h0.6','h0.6','h1.2','f2','h6','f12','h12']
x_ch2 = findgen(n_elements(frametime_ch2))
y_ch2 = [ch2_pipeline_shift2(0), ch2_pipeline_shift1(1), ch2_pipeline_shift2(2), ch2_pipeline_shift1(3), ch2_pipeline_shift2(4), ch2_pipeline_shift2(5),ch2_pipeline_shift1(6), ch2_pipeline_shift1(7) ]
...
l = legend(target = [e3,e4,t1,t2], position = [5,14],/data)
l2 = legend(target = [e1,e2,e7, e8], position = [1, 14], /data)
...
l = legend(target = [e7,e8,t3,t4], position = [5.5,14],/data)
l = legend(target = [e5,e6,e17,e18], position = [1,14],/data)

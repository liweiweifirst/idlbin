pro exoplanet_phot
  colorarr = [ 'SKY_BLUE'  , 'SLATE_BLUE' , 'SLATE_GREY' , ' red',  'PLUM' ,  'SPRING_GREEN'  ,  'STEEL_BLUE'   ,  'green', 'TEAL' ,  'THISTLE' ,  'TOMATO'  ,  'TURQUOISE' ,  'VIOLET' , 'YELLOW'  ,  'YELLOW_GREEN', 'PAPAYA_WHIP'  ,' PEACH_PUFF','   PERU',   ' POWDER_BLUE' ]
...
;  fits_read, '/Users/jkrick/irac_warm/pmap/pmap_ch2_0p4s_500x500_0043_111206/ygrid_ch2_0p4s_500x500_0043_111206.fits', ygriddata, ygridheader
  ...
  for a = 0 , n_elements(aorname) - 1 do begin
     ...
     dir = '/Users/jkrick/irac_warm/pcrs_test/' + string(aorname(a)) 
     CD, dir                    ; change directories to the correct AOR directory
     command  =  " ls *bcd_fp.fits > /Users/jkrick/irac_warm/pcrs_test/bcdlist.txt"
     spawn, command
     command2 =  "ls *sig_dntoflux.fits > /Users/jkrick/irac_warm/pcrs_test/bunclist.txt"
     spawn, command2

     readcol,'/Users/jkrick/irac_warm/pcrs_test/bcdlist.txt',fitsname, format = 'A', /silent
     readcol,'/Users/jkrick/irac_warm/pcrs_test/bunclist.txt',buncname, format = 'A', /silent
 ...
 ;    corrfluxerrarr = fltarr(n_elements(fitsname)*63)
     ...
     for i =0.D, 9. do begin;  n_elements(fitsname) - 1 do begin ;read each cbcd file, find centroid, keep track

...
aorname = 'r44605184'
  ...
  AORhd7924 = replicate({obhd7924, ra:0D,dec:0D,xcen:dblarr(nfits),ycen:dblarr(nfits),flux:dblarr(nfits),fluxerr:dblarr(nfits), corrflux:dblarr(nfits), corrfluxerr:dblarr(nfits), sclktime_0:0D, timearr:dblarr(nfits),aor:' ', bmjdarr:dblarr(nfits), utcsarr:dblarr(nfits), bkgd:dblarr(nfits), bkgderr:dblarr(nfits)},n_elements(aorname)) ;, xfwhmarr:dblarr(nfits), yfwhmarr:dblarr(nfits

     print, 'working on ',aorname
     dir = '/Users/jkrick/irac_warm/pcrs_planets/hd7924/'+ aorname 
     CD, dir                    ; change directories to the correct AOR directory
     command  =  "find ch2/bcd -name '*_bcd.fits' > /Users/jkrick/irac_warm/pcrs_planets/hd7924/cbcdlist.txt"
     spawn, command
     command2 =  "find  ch2/bcd -name '*bunc.fits' > /Users/jkrick/irac_warm/pcrs_planets/hd7924/bunclist.txt"
     spawn, command2

     readcol,'/Users/jkrick/irac_warm/pcrs_planets/hd7924/cbcdlist.txt',fitsname, format = 'A', /silent
     readcol,'/Users/jkrick/irac_warm/pcrs_planets/hd7924/bunclist.txt',buncname, format = 'A', /silent
...
;     print, 'n xarr, fluxarr, nfits', n_elements(xarr), n_elements(fluxarr), nfits
     AORhd7924={obhd7924,  ra_ref,dec_ref,xarr,yarr,fluxarr,fluxerrarr, corrfluxarr, corrfluxerrarr, sclk_0, timearr,aorname,bmjd,utcs, backarr, backerrarr};, xfwhmarr, yfwhmarr
  
  ;test
  print, AORhd7924[0].ra, AORhd7924[0].xcen[26]
  
  save, AORhd7924, filename='/Users/jkrick/irac_warm/pcrs_planets/hd7924/hd7924_phot_ch2.sav'

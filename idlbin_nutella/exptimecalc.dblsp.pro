;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;April 2004
;extimate exposure time for dblsp on Palomar
;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
device, filename = '/Users/jkrick/fossils/palomar_2011a/exptime_02.ps', /portrait, $
...
f = f *2.03E5  ;palomar 5mtr diameter
...
;from http://www.astro.caltech.edu/observatories/palomar/200inch/dbl_spec/dbl_spec.html
;600/4000 D68
...
;(trujillo)
f = f *0.2  ; a guess for large galaxies

;correct for final resolution (grating + slit smearing)
res = 1.077                                                 ;angstroms/pix for 600/mm 3780 blaze; blue side
f = f *res                                              ;now in units of photons/(s pix)

;adjust for gain   now in units of counts/s pix
gain = 0.72                         ; blue http://www.astro.caltech.edu/observatories/palomar/200inch/dbl_spec/dbl_spec.html
f = f /gain
...
;readnoise
R = 2.5 ;e-
R = R/gain                       ;  http://www.astro.caltech.edu/observatories/palomar/200inch/dbl_spec/dbl_spec.html

...
!p.multi = [0, 1, 1]
;!p.multi = [0, 1, 2]
ps_open, file = "/Users/jkrick/nep/clusters/cluster.cmd.test.ps", /portrait, /color,/square, xsize=4, ysize=4
...
;;   plothist, objectnew[good].zphot, bin = 0.05, xrange=[0,1.5], /xstyle, thick = 3, xthick = 3, ythick = 3, $
...
;coeff = ROBUST_LINEFIT( objectnew.rmaga, objectnew.vr, yfit, sig, coeff_sig)

...
SET_PLOT, 'ps'
print,"hello"
device, filename = '/n/Godiva2/jkrick/A141/maskdisp.ps', /portrait, $
...
openw, outlun, "/n/Godiva2/jkrick/A141/gallist",/get_lun
openr,lun, "/n/Godiva7/jkrick/IMACS/masktest", /get_lun
whole = "string"
plotimage, bytscl(data,min=-54,max=50), xrange=[-2200,6000],yrange=[-500,6000]

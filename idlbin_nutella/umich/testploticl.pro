...
device, filename = '/n/Godiva1/jkrick/A3888/iclnewnocolor.ps', /portrait, $
...
YRANGE = [31, 23], xrange = [0,300],ytitle = 'Surface Brightness (mag/squarcsec)', $
...
oplot, findgen(400) , findgen(400)  - findgen(400) + 28.8, thick = 3, linestyle = 2;, color = colors.seagreen
...
xyouts, 265,29.1, '95% CL', charthick = 3
...
xyouts, 288, 23.4, 'h(70)^-1kpc', charthick = 3, alignment = 0.5
...
;r  curve
OPENR, lun,'/n/Godiva1/jkrick/A3888/final/testgalrtab', /GET_LUN
...
oplot, rradius2* 0.259,24.6 - 2.5*alog10(rcounts2/(0.259^2)),thick = 3
oplot, rradius3* 0.259,24.6 - 2.5*alog10(rcounts3/(0.259^2)),thick = 5;, color = colors.orangered
...
oplot, findgen(400), findgen(400)  - findgen(400) + 28.0, thick = 3;, color = colors.orangered

...
FITS_READ, '/n/Godiva3/jkrick/A2556/original/centerblank.fits', blankdata, blankheader

filename = "/n/Godiva3/jkrick/A2556/original/centerr"
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 2.9 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN   
...
;            return = del_star(pa, f, 22, 22, xcenter, ycenter, data)
           return = del_star(pa, f, 23, 23, xcenter, ycenter, data)
;           return = del_star(pa, f, 23, 23, xcenter, ycenter, blankdata)
            true = 1
...
;            holder = starmask (f, xcenter, ycenter, maxradius,xmax,ymax,blankdata)
	...
	;seeing, focus, ...
            ...
            b= 23;19               ;block out star up to a radius of B1 pixels
            a= 23;19
            return = del_star(pa, f, a , b, xcenter, ycenter, data)
...
fits_write,'/n/Godiva3/jkrick/A2556/original/centerr.bblock.fits', data, header

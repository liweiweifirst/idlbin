...
OPENR, lun1, "/n/Godiva1/jkrick/A4059/cmd/2df.A4059.txt", /GET_LUN, ERROR = err
...
openr, lun3, "/n/Godiva1/jkrick/A4059/cmd/smith.member.txt", /GET_LUN
WHILE (NOT eof(lun3)) DO BEGIN
    READF, lun3,r,d,junk,junk,junk,junk,junk,junk,junk,junk
    adxy, header, r, d, xcen, ycen
;;    print, r, d, xcen,ycen
    galaxy[i] = {object, r, d, 0.05, xcen, ycen}
    i = i +1;;;;;
...
openr, lun3, "/n/Godiva1/jkrick/A4059/cmd/smith.nonmember.txt", /GET_LUN
WHILE (NOT eof(lun3)) DO BEGIN
    READF, lun3,r,d,junk,junk,junk,junk
    adxy, header, r, d, xcen, ycen ;
    ngalaxy[n] = {object, r, d, 0.05, xcen, ycen}
    n = n + 1
ENDWHILE
close, lun3
free_lun, lun3
...
;----------------------------------------------------------------------
ps_open, file = "/n/Godiva1/jkrick/A4059/membership.ps", /portrait, /color, ysize = 7

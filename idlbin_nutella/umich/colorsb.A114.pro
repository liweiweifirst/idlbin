...
device, filename = '/n/Godiva4/jkrick/A114/iclcolor.ps', /portrait, $
  BITS=8, scale_factor=0.9 ;, /color


fits_read, "/n/Godiva4/jkrick/A114/original/centersmo.r.fits", data, header
...
plotimage, bytscl(data, min = 0, max = 7) ,$; bytscl(data, min=1,max=3),$
 /preserve_aspect, /noaxes, ncolors=8

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

OPENR, lun,'/n/Godiva4/jkrick/A114/original/rtab', /GET_LUN 
rows= 6
sma = FLTARR(rows)
ellip = FLTARR(rows)
r = 0.0				;radius
...
oplot, findgen(200)+140 , findgen(200) -findgen(200)+ 190, thick = 3,color = 245
xyouts,120,140,'400 kpc', color = 245, charthick = 3

...
device, filename = '/Users/jkrick/umich/icl/A4059/profiles.ps', /portrait, $
...
;oplot, radius[0:j-1]*0.435, 22.04 - 2.5*alog10(numbers/(0.435^2)), thick = 5, color = colors.orange


;devauc fitting and plotting of cD as well
start = [0.03,200.0]
result2 = MPFITFUN('devauc',radiusc,countsc, Verr1c, start)    ;ICL

numbers = (result2(0)) * (exp(-7.67*(((radiusc/result2(1))^(1.0/4.0)) - 1.0)))
oplot, radiusc*0.435, 22.04 - 2.5*alog10(numbers/(0.435^2)), thick = 5, color = colors.green



;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/icl2r2tab', /GET_LUN
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;lower limit, 30% larger galaxy masks
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/icl2r3tab', /GET_LUN
...
FOR counter = 0, n_elements(countsc) - 1, 1 DO BEGIN
    IF (countsc(counter) - .0009877 LE 0. )THEN BEGIN
        lower2(counter) = 35.
    ENDIF ELSE BEGIN
        lower2(counter) = 22.04 - 2.5*alog10((countsc(counter) - .0009877)/(0.435^2))
    ENDELSE
ENDFOR

upper2 = 22.04 - 2.5*alog10((countsc + .0009877)/(0.435^2)) 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/gal2rtab', /GET_LUN
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/cdBtab', /GET_LUN
...
oplot, radiusc* 0.435,22.19 - 2.5*alog10(countsc/(0.435^2)),thick = 3, color = colors.black;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/icl2B2tab', /GET_LUN
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/Users/jkrick/umich/icl/A4059/icl2B3tab', /GET_LUN
...
lower2 = fltarr(n_elements(countsc))
FOR counter = 0, n_elements(countsc) - 1, 1 DO BEGIN
    IF (countsc(counter) - .000153 LE 0. )THEN BEGIN
        lower2(counter) = 35.
    ENDIF ELSE BEGIN
        lower2(counter) = 22.19 - 2.5*alog10((countsc(counter) - .000153)/(0.435^2))
    ENDELSE
ENDFOR

upper2 = 22.19 - 2.5*alog10((countsc + .000153)/(0.435^2)) 
errplot, radiusc* 0.435,lower2, upper2
...
;devauc fitting of cD
start = [0.03,200.0]
result2 = MPFITFUN('devauc',radiusc,countsc, Verr1c, start)    ;ICL

numbers = (result2(0)) * (exp(-7.67*(((findgen(700)/result2(1))^(1.0/4.0)) - 1.0)))
oplot, findgen(700)*0.435, 22.19 - 2.5*alog10(numbers/(0.435^2)), thick = 5, color = colors.green;


;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

OPENR, lun,'/Users/jkrick/umich/icl/A4059/gal2Btab', /GET_LUN

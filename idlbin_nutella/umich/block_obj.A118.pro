...
;saty = [87.598, 730.642,906.213
;,1112.002,990.919,1019.269,1696.995,1582.452,1642.321, 1535.170 ]

satx = [ 1512.800, 378.860,104.434,336.342,1537.920, 1272.935,133.222,349.000,501.102 ]
saty = [87.598, 730.642,906.213 ,1112.002,1019.269,1696.995,1582.452,1642.321, 1535.170 ]
satrmag=[14.0, 14.8,13.6,11.3,14.9,12.6,14.2,11.9,15.7]
satVmag=[14.8, 15.2,14.1,11.3,15.2,13.0,14.6,12.0,16.2]
...
WHILE (NOT EOF(lun)) DO BEGIN
    ...
    READF, lun, xcenter, ycenter, a, b, e, f, m, isoarea, fwhm, pa, bkgd, apflux,isocorflux,isoflux
;    print, "working on object", o
    IF xcenter GT 1100 AND xcenter LT 1340 AND ycenter LT 1056 AND ycenter GT 793 THEN true = 1
...
;;fits_write, '/n/Godiva7/jkrick/A118/original/mask.bblock2.galr.fits',shift(blankdata,-1,-1), blankheader

lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva7/jkrick/A114/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/n/Godiva7/jkrick/A118/original/larger.s.fits', data, header

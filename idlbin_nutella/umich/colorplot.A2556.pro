...
OPENR, lun,'/Users/jkrick/umich/icl/A2556/icl2Btab', /GET_LUN  ;iclVtab2
rows=10
radius = FLTARR(rows)
counts = FLTARR(rows)
Verr = FLTARR(rows)
...
interprradius = interpolate(rradius, [1,2,3,3.5,4,5,6,7,8,9])
interprcounts = interpolate(rcounts, [1,2,3,3.5,4,5,6,7,8,9])
...
device, filename = '/Users/jkrick/umich/icl/A2556/color.ps', /portrait, $
  BITS=8, scale_factor=0.9 , /color

plot, radarr*0.435, color, psym = 2, xrange = [0,220], ytitle ="B-r",thick = 3,$
...
axis, 0, 2.5, xaxis=1, xrange=[0,0.424], xstyle = 1, xthick = 3,charthick = 3
...
x= findgen(100) + 220
y = x - (findgen(100)+220) + 2.1
;y2 = x - (findgen(100)+135) + 0.0

oplot, x, y, thick = 3
;oplot, x, y2, thick = 3
xyouts,224, 2.04, 'RCS', charthick = 3
;xyouts, 230, 0.02, 'Tidal Features', charthick = 3
xyouts, 30, 2.4, "A2556", charthick = 3
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
sum = total(color)

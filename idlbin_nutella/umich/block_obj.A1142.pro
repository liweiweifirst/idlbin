...
FITS_READ, '/Users/jkrick/umich/icl/A114/largeblank.fits', blankdata, blankheader

filename = "/Users/jkrick/umich/icl/A114/larger.div"
;print, "working on", filename

imagefile = filename + '.fits'
datafile = '/Users/jkrick/umich/icl/A114/SExtractor.r.cat'
...
;commandline = '/n/Godiva7/jkrick/Sex/sex ' + imagefile + " -c /n/Godiva7/jkrick/A114/iclr.sex"
;spawn, commandline
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 2.8 AND fwhm LE 4.0 AND true EQ 0) THEN BEGIN   
        openw, dimlun, "/Users/jkrick/umich/icl/A114/tvmark.out", /GET_LUN, /append
...
;    IF (fwhm GT 4.2 AND true EQ 0) THEN BEGIN
 ...
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
                    sma = ((1.4*sma)+1.45)/0.91 ; 2.6,2.0,1.4                 
                    smb =  ((1.4*smb)+1.45)/0.91 ;  2.6,2.0,1.4                 
                ENDIF ELSE BEGIN

                    sma =  ((1.6*sma)+1.45)/0.91 ; 3.0,2.3 ,1.6                 
                    smb =  ((1.6*smb)+1.45)/0.91 ; 3.0,2.3,1.6                  
                ENDELSE
        ...
        IF run EQ 1 THEN begin
            IF (sma GT 15.0 OR smb GT 15.0) THEN BEGIN ;big galaxies
                IF(isoarea GT 2000.) THEN BEGIN
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
                    sma =  ((2.0*sma)+1.45)/0.91 ; 2.6,2.0,1.4                 
                    smb =  ((2.0*smb)+1.45)/0.91 ;  2.6,2.0,1.4                 
                ENDIF ELSE BEGIN

                    sma =  ((2.3*sma)+1.45)/0.91 ; 3.0,2.3 ,1.6                 
                    smb =  ((2.3*smb)+1.45)/0.91 ; 3.0,2.3,1.6                  
                ENDELSE
        ...
        IF run EQ 2 THEN begin
            IF (sma GT 15.0 OR smb GT 15.0) THEN BEGIN ;big galaxies
                IF(isoarea GT 2000.) THEN BEGIN
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
                    sma =  ((2.6*sma)+1.45)/0.91 ; 2.6,2.0,1.4                 
                    smb =  ((2.6*smb)+1.45)/0.91 ;  2.6,2.0,1.4                 
                ENDIF ELSE BEGIN

                    sma =  ((3.0*sma)+1.45)/0.91 ; 3.0,2.3 ,1.6                 
                    smb =  ((3.0*smb)+1.45)/0.91 ; 3.0,2.3,1.6                  
                ENDELSE
...
;them
;j = "j"
;OPENR, lunicl, "/n/Godiva7/jkrick/A114/iclr.sex", /GET_LUN
...
IF run EQ 0 THEN begin
fits_write, '/Users/jkrick/umich/icl/A114/mask.block2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A114/fullr.block2.fits', data, header
ENDIF
IF run EQ 1 THEN begin
fits_write, '/Users/jkrick/umich/icl/A114/mask.bblock2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A114/fullr.bblock2.fits', data, header
ENDIF
IF run EQ 2 THEN begin
fits_write, '/Users/jkrick/umich/icl/A114/mask.vbblock2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A114/fullr.vbblock2.fits', data, header
ENDIF

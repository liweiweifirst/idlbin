...
numogals = 6
;close, /all
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/xydiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/magdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/rediag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/axisdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/padiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/bkgddiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/dsxdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/dsydiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/exp0diag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/sixexp/exp1diag.log"
...
openr, mainlun, "/n/Godiva7/jkrick/galfit/sixexp/listdiag", /get_lun, ERROR = err
...
;                gal[1].pa2 = s[6]
 ...
 ;                        print, "inside gal[3] if t eq 5"
                ...
                ENDIF
                 ...
                 IF (round(float(s[0])) EQ round(gal[4].xcenter)) AND (round(float(s[1])) EQ round(gal[4].ycenter))$
                  THEN BEGIN
                    IF (t EQ 5) THEN BEGIN
 ;                        print, "inside gal[4] if t eq 5"
                         gal[4].xcenter2 = s[0]
                         gal[4].ycenter2 = s[1]
                         gal[4].chi2= s[2]
                         gal[4].mag2 = s[3]
                    ...
                    IF (gal[4].re2 GT 100) THEN gal[4].xcenter2 = 0.
                    IF (gal[4].axisratio2 LT 0.09) THEN gal[4].xcenter2 = 0.
                    IF (t EQ 9) THEN s = strsplit(filearr[j-1], /extract)
                    
                ENDIF


                IF (round(float(s[0])) EQ round(gal[5].xcenter)) AND (round(float(s[1])) EQ round(gal[5].ycenter))$
                  THEN BEGIN
                    IF (t EQ 5) THEN BEGIN
 ;                        print, "inside gal[5] if t eq 5"
                         gal[5].xcenter2 = s[0]
                         gal[5].ycenter2 = s[1]
                         gal[5].chi2= s[2]
                         gal[5].mag2 = s[3]
                    ...
                    IF (gal[5].re2 GT 100) THEN gal[5].xcenter2 = 0.
                    IF (gal[5].axisratio2 LT 0.09) THEN gal[5].xcenter2 = 0.
                    IF (t EQ 9) THEN s = strsplit(filearr[j-1], /extract)
...
;    ENDIF
    ...
    print, fracpercent,"fracpercent"
    sname = strcompress("/n/Godiva7/jkrick/galfit/sixexp/nogals" + string(k)  + "." + $
    ...
    FOR i = 0,77,1 DO BEGIN     ;there are 77 background images
    ...
    print, "exp0orig, expresult[0], exp0diff",  exp0orig, expresult[0], exp0diff
...
;    dist  = sqrt((gal[0].xcenter - gal[2].xcenter)^2 + (gal[0].ycenter - gal[2].ycenter)^2)
    dist = abs(gal[3].ycenter - gal[2].ycenter)
...
;put them into files
    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/xydiag.log", /GET_LUN, /append
    printf, outlun, dist, x10percent, x20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/magdiag.log", /GET_LUN, /append
    printf, outlun, dist, mag10percent, mag20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/rediag.log", /GET_LUN, /append
    printf, outlun, dist, re10percent,re20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/axisdiag.log", /GET_LUN, /append
    printf, outlun, dist, axis10percent,axis20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/padiag.log", /GET_LUN, /append
    printf, outlun, dist, pa10percent,pa20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/bkgddiag.log", /GET_LUN, /append
    printf, outlun, dist, bkgd10percent,bkgd20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/dsxdiag.log", /GET_LUN, /append
    printf, outlun, dist, dsx10percent,dsx20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/dsydiag.log", /GET_LUN, /append
    printf, outlun, dist, dsy10percent,dsy20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/sixexp/exp0diag.log", /GET_LUN, /append
    printf, outlun, dist, exp010percent,exp020percent
    close, outlun
    free_lun, outlun

    openw, outlun2, "/n/Godiva7/jkrick/galfit/sixexp/exp1diag.log", /GET_LUN, /append, ERROR = err
...
device, filename = '/n/Godiva7/jkrick/galfit/sixexp/frac.ps', /portrait, $
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/xydiag.log", /GET_LUN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/magdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/rediag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/axisdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/padiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/bkgddiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/dsxdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/dsydiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/exp0diag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
    readf, whatever, distin, dsypointin, second
...
free_lun, whatever
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/sixexp/exp1diag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
    readf, whatever, distin, dsypointin, second
...
plot, newdist, newxy10point,thick = 3, xrange = [0,60],$
       YRANGE = [0,1.5] ,psym = -5,$
...
plot, newdist, newxy20point,thick = 3,  xrange = [0,60],$
       YRANGE = [0,1.5] ,psym = -5,$
        ytitle = 'fraction of gals correct ',   xtitle = 'distance between galaxies (pixels)', $
        subtitle = '6 galaxies per simulation, 20 simulations at each separation distance'

...
;exponential fitting
result2 = MPFITFUN('exponential',radius[0:j-3],counts[0:j-3], Verr, start)    ;ICL

;exponential plotting
oplot, findgen(510)*0.435, 22.04 - 2.5*alog10(result2(0)*exp(-findgen(510)/result2(1))/(0.435^2) ), thick = 3, color = colors.red

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/n/Godiva3/jkrick/A2556/original/icl2r2tab', /GET_LUN
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;lower limit, 30% larger galaxy masks
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/n/Godiva3/jkrick/A2556/original/icl2r3tab', /GET_LUN
...
FOR counter = 0, n_elements(counts) - 1, 1 DO BEGIN
    IF (counts(counter) - .001047 LE 0. )THEN BEGIN
        lower2(counter) = 35.
    ENDIF ELSE BEGIN
        lower2(counter) = 22.04 - 2.5*alog10((counts(counter) - .00104)/(0.435^2))
    ENDELSE
ENDFOR
...
start = [0.03,200.0]
result2 = MPFITFUN('devauc',radius,counts, Verr1, start)    ;ICL

numbers = (result2(0)) * (exp(-7.67*(((radius/result2(1))^(1.0/4.0)) - 1.0)))
oplot, radius*0.435, 22.19 - 2.5*alog10(numbers/(0.435^2)), thick = 5, color = colors.black

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/n/Godiva3/jkrick/A2556/original/gal2rtab', /GET_LUN
...
;exponential plotting
oplot, findgen(510)*0.435, 22.19 - 2.5*alog10(result2(0)*exp(-findgen(510)/result2(1))/(0.435^2) ), thick = 3, color = colors.blue



;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
OPENR, lun,'/n/Godiva3/jkrick/A2556/original/icl2B2tab', /GET_LUN
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;OPENR, lun,'/n/Godiva3/jkrick/A2556/original/icl2B3tab', /GET_LUN
...
FOR counter = 0, n_elements(countsB) - 1, 1 DO BEGIN
    IF (countsB(counter) - .000247 LE 0. )THEN BEGIN
        lower2(counter) = 35.
    ENDIF ELSE BEGIN
        lower2(counter) = 22.19 - 2.5*alog10((countsB(counter) - .000247)/(0.435^2))
    ENDELSE
ENDFOR

upper2 = 22.19 - 2.5*alog10((countsB + .000247)/(0.435^2)) 
errplot, radiusB* 0.435,lower2, upper2
;devauc fitting and plotting
start = [0.03,200.0]
result2 = MPFITFUN('devauc',radiusB,countsB, Verr, start)    ;ICL
...
OPENR, lun,'/n/Godiva3/jkrick/A2556/original/gal2Btab', /GET_LUN
...
xyouts, 20, 24.5, "A2556", charthick=3
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

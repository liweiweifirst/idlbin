...
filename = "/n/Godiva4/jkrick/A141/original/largeV"
print, "working on", filename

imagefile = filename + '.fits'
datafile = '/n/Godiva4/jkrick/A141/SExtractor.V.cat'
;datafile = '/n/Godiva4/jkrick/A141/original/block_obj.r.input'
newimagefile = filename + '.s.fits'	
outfile = filename + '.bblock.fits'


;run SExtractor on the image to find the objects
commandline = '/n/Godiva7/jkrick/Sex/sex ' + imagefile + " -c /n/Godiva4/jkrick/A141/iclV.sex"
spawn, commandline
...
satx = [ 129.91, 2116.17 ,740.46 ,1284.96]
;saty = [2200.13, 2427.32 ,158.29   ,481.88  ,15.42]
saty = [2200.13, 2427.32 ,481.88  ,15.42]
...
;fits_write, '/n/Godiva4/jkrick/A141/original/maskno5.bblock.r.fits',shift(blankdata,-1,-1), blankheader

lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva4/jkrick/A141/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/n/Godiva4/jkrick/A141/original/largeV.bblock.copy.fits', data, header

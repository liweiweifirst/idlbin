...
FITS_READ, '/Users/jkrick/umich/icl/A2734/fullblank.fits', blankdata, blankheader

filename = "/Users/jkrick/umich/icl/A2734/fullB"

imagefile = filename + '.fits'
datafile = '/Users/jkrick/umich/icl/A2734/SExtractor.B.cat'
...
satBmag = fltarr(200)
l = 0
OPENR, satlun, '/Users/jkrick/umich/icl/A2734/satstar.txt', /GET_LUN
fits_read, '/Users/jkrick/umich/icl/A2734/fullr.wcs.fits', datawcs, headerwcs
...
;    print, "working on object", o
    ...
    IF (f LT 0) AND isoarea GT 50 THEN BEGIN    ;is a real object on top of the bad column
        ...
        return = del_star_A2734(pa, f, sma , smb, xcenter, ycenter, data)
        true = 1
    ENDIF
    ...
    IF(isoarea LT 6.0 OR fwhm LT 2.8 AND true EQ 0) THEN BEGIN  ;2.5
        ...
        a = a + 2
        b = b + 2
       return = del_star_A2734(pa, f, a , b, xcenter, ycenter, data)
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 2.8 AND fwhm LE 4.1 AND true EQ 0) THEN BEGIN   
        openw, dimlun, "/Users/jkrick/umich/icl/A2734/tvmark.out", /GET_LUN, /append
        ...
        IF (m GT 22.1) THEN BEGIN
            return = del_star_A2734(pa, f, 5, 5, xcenter, ycenter, data)
;            return = del_star_A2734(pa, f, 5, 5, xcenter, ycenter, blankdata)
            true = 1
...
;            return = del_star_A2734(pa, f, 22, 22, xcenter, ycenter, data)
           return = del_star_A2734(pa, f, 30, 30, xcenter, ycenter, data)
;           return = del_star_A2734(pa, f, 30, 30, xcenter, ycenter, blankdata)
            true = 1
...
;            holder = starmask (f, xcenter, ycenter, maxradius,xmax,ymax,blankdata)
	...
	;seeing, focus, ...
            ...
            a= 30;19
            return = del_star_A2734(pa, f, a , b, xcenter, ycenter, data)
;            return = del_star_A2734(pa, f, a , b, xcenter, ycenter, blankdata)
...
;fits_write, '/Users/jkrick/umich/icl/A2734/mask.block.r.fits',shift(blankdata,-1,-1), blankheader

lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva4/jkrick/A4010/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/Users/jkrick/umich/icl/A2734/fullB.bblock.fits', data, header
...
;device, filename = '/n/Godiva4/jkrick/A2734/masksizes.ps', /portrait, $

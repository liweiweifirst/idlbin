...
numogals = 4
;close, /all
spawn, "rm /n/Godiva7/jkrick/galfit/exp/xydiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/magdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/rediag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/axisdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/padiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/bkgddiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/dsxdiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/dsydiag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/exp0diag.log"
spawn, "rm /n/Godiva7/jkrick/galfit/exp/exp1diag.log"
...
;    ENDIF
    ...
    sname = strcompress("/n/Godiva7/jkrick/galfit/exp/nogals" + string(k)  + "." + $
...
;put them into files
    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/xydiag.log", /GET_LUN, /append
    printf, outlun, dist, x10percent, x20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/magdiag.log", /GET_LUN, /append
    printf, outlun, dist, mag10percent, mag20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/rediag.log", /GET_LUN, /append
    printf, outlun, dist, re10percent,re20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/axisdiag.log", /GET_LUN, /append
    printf, outlun, dist, axis10percent,axis20percent
    close, outlun
    free_lun, outlun
    
    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/padiag.log", /GET_LUN, /append
    printf, outlun, dist, pa10percent,pa20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/bkgddiag.log", /GET_LUN, /append
    printf, outlun, dist, bkgd10percent,bkgd20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/dsxdiag.log", /GET_LUN, /append
    printf, outlun, dist, dsx10percent,dsx20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/dsydiag.log", /GET_LUN, /append
    printf, outlun, dist, dsy10percent,dsy20percent
    close, outlun
    free_lun, outlun

    openw, outlun, "/n/Godiva7/jkrick/galfit/exp/exp0diag.log", /GET_LUN, /append
    printf, outlun, dist, exp010percent,exp020percent
    close, outlun
    free_lun, outlun

    openw, outlun2, "/n/Godiva7/jkrick/galfit/exp/exp1diag.log", /GET_LUN, /append, ERROR = err
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/xydiag.log", /GET_LUN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/magdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/rediag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/axisdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/padiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/bkgddiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/dsxdiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/dsydiag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
...
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/exp0diag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
    readf, whatever, distin, dsypointin, second
...
free_lun, whatever
i  = 0
openr, whatever, "/n/Godiva7/jkrick/galfit/exp/exp1diag.log", /GET_LUN
WHILE (NOT eof(whatever)) DO BEGIN
    readf, whatever, distin, dsypointin, second
...
openw, outre, "/n/Godiva7/jkrick/galfit/exp/deltare.log", /GET_LUN, /append
printf, outre, deltare
close, outre
free_lun, outre
    
print, "deltamag", deltamag
print, "deltare", deltare
print, "deltapa", deltapa
print, "deltaar", deltaar
...
device, filename = '/n/Godiva7/jkrick/galfit/exp/frac.ps', /portrait, $
  BITS=8, scale_factor=0.9 , /color

plot, newdist, newxy10point,thick = 3, $
       YRANGE = [0,1.5] ,psym = -5, charthick = 3,$
...
plot, newdist, newxy20point,thick = 3, $
       YRANGE = [0,1.5] ,psym = -5,$
        ...
        subtitle = '4 galaxies per simulation, 20 simulations at each separation distance', charthick = 3
...
!p.multi= [0, 0, 1]
SET_PLOT, 'ps'
device, filename = '/n/Godiva7/jkrick/galfit/exp/maghist.ps', /portrait, $
  BITS=8, scale_factor=0.9 , /color
...
!p.multi= [0, 0, 1]
SET_PLOT, 'ps'
device, filename = '/n/Godiva7/jkrick/galfit/exp/rehist.ps', /portrait, $
  BITS=8, scale_factor=0.9 , /color
...
;p.multi= [0, 0, 1]
;SET_PLOT, 'ps'
;device, filename = '/n/Godiva7/jkrick/galfit/exp/pahist.ps', /portrait, $
;  BITS=8, scale_factor=0.9 , /color
;plothist, deltapa, xhist, yhist, bin = 0.5, xrange = [-20,20],xtitle= "delta PA", ytitle= "N", thick = 3, title = "PA histogram",  fcolor = blue, charthick = 3;

;start = [0.01,0.1]
;err = dindgen(i-1) - dindgen(i-1) + 1         ;make a simple error array, all even errors
;result1 = MPFITFUN('gauss',xhist, yhist, err, start);, weights=weight);,PARINFO=pi);, weights=weight)
;xaxis = findgen(1000) / 1000
;;oplot, xhist, gauss1(xhist, result1(0:2)), color = colors.red, thick = 5
;oplot, xaxis, 1./(result1(1)*sqrt(2.*!Pi)) * exp(-0.5*((xaxis - result1(0))/result1(1))^2.), color = colors.red, thick = 5

;start2 = [200.0, 0.03, 0.05]
;yfit = gaussfit(xhist, yhist, A, estimates = start2, nterms = 3)
;print, "paramters for gaussfit are ", A
;oplot, xhist, yfit, color = colors.green, thick = 5
;device, /close
;set_plot, mydevice
;-----------------------------------------------------------------------------------------
...
!p.multi= [0, 0, 1]
SET_PLOT, 'ps'
device, filename = '/n/Godiva7/jkrick/galfit/exp/arhist.ps', /portrait, $
  BITS=8, scale_factor=0.9 , /color

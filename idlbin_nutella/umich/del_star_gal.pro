...
function del_star_gal, theta, f , a , b, X, Y, data
...
xmax = 3190;1601;2049;1900;2866;1900;2866;2048;2000;2800;1000
ymax = 3650;1801;3148;2100;3486;2100;3486;3148;2000;2700;1000
                ...
                IF (yedge+y GT 0 AND yedge+y LT ymax) THEN BEGIN
                    ...
                    IF ((xedge+x) LT x) THEN BEGIN
                        If (yedge+y LT y) THEN BEGIN
                            data[xedge+x:x,yedge+y:y] = 0
                        ENDIF ELSE BEGIN
                            data[xedge+x:x,y:yedge+y] = 0
                        ENDELSE
                    ENDIF ELSE BEGIN
                        If (yedge+y LT y) THEN BEGIN
                            data[x:xedge+x,yedge+y:y] = 0
                        ENDIF ELSE BEGIN
                            data[x:xedge+x,y:yedge+y] = 0
                        ENDELSE
                    ENDELSE
                ENDIF
            ENDIF

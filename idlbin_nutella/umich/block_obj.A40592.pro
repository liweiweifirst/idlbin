...
;        ENDIF
        ...
        smaarr[smacount] = sma
        smacount = smacount + 1
        IF o EQ 4123 THEN print, "o=4123 inside galaxies",xcenter, ycenter, sma,smb 
    ENDIF
...
IF run EQ 0 THEN begin
fits_write, '/n/Godiva1/jkrick/A4059/original/mask.block2.r.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/n/Godiva1/jkrick/A4059/original/fullr.block2.fits', data, header
print, "just wrote A4059 block"
ENDIF

IF run EQ 1 THEN begin
fits_write, '/n/Godiva1/jkrick/A4059/original/mask.bblock2.r.ell.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/n/Godiva1/jkrick/A4059/original/fullr.bblock2.ell.fits', data, header
print, "just wrote A4059 bblock"
ENDIF

IF run EQ 2 THEN begin
fits_write, '/n/Godiva1/jkrick/A4059/original/mask.vbblock2.r.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/n/Godiva1/jkrick/A4059/original/fullr.vbblock2.fits', data, header
print, "just wrote A4059 bblock"
ENDIF

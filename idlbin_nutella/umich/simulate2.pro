...
;k = 0       
        ...
        openw, outlun, "/n/Godiva7/jkrick/galfit/4n/simulate.pro.feedme", /GET_LUN
        
        printf, outlun, "#IMAGE PARAMETERS"
        printf, outlun, "A) ", "none" ;, "   # Input data image (FITS file)"
        printf, outlun, "B) ", "/n/Godiva7/jkrick/galfit/4n/fake.fits" ;, "     # Name for the output image"
        printf, outlun, "C) ", "/n/Godiva7/jkrick/galfit/4n/noise400.fits" ;, "   # Noise image name(made from data if blank or none) "
        printf, outlun, "D) ", "/n/Godiva7/jkrick/galfit/4n/psf.small.fits" ;,"            # Input PSF image for convolution (FITS file)"
        printf, outlun, "E) ", "none" ;, "           # Pixel mask (ASCII file or FITS file with non-0 values)"
        printf, outlun, "F) /n/Godiva7/jkrick/galfit/4n/const.test	       # Parameter constraint file (ASCII)"
        ...
        printf, outlun, "###########################################################################"
        openw, dlun3, "/n/Godiva7/jkrick/galfit/4n/diagnostics.log", /GET_LUN, /append
...
;            printf, outlun, " 0) devauc             # Object type"
        ...
        spawn, "/n/Godiva7/jkrick/galfit/galfit/galfit  /n/Godiva7/jkrick/galfit/4n/simulate.pro.feedme"
        
        spawn, "rm galfit.??"
        
        fits_read, "/n/Godiva7/jkrick/galfit/4n/fake.fits", fakedata, fakeheader
...
;        print, "using ", name
        ...
        fits_write, "/n/Godiva7/jkrick/galfit/4n/fake.fits", fakedata, fakeheader

        free_lun, dlun3
        close, dlun3
        
        galfit2, "/n/Godiva7/jkrick/galfit/4n/fake.fits", "/n/Godiva7/jkrick/galfit/4n/noise400.fits", "/n/Godiva7/jkrick/galfit/4n/psf.small.fits", "/n/Godiva7/jkrick/galfit/4n/segmentation.fits", "/n/Godiva7/jkrick/galfit/4n/"
        
        newname = strcompress("/n/Godiva7/jkrick/galfit/4n/diagnostics" + string(k)  + "." + string(dist) + ".log", /remove_all)
        newcommand = "mv /n/Godiva7/jkrick/galfit/4n/diagnostics.log "+  newname

;        newimg = strcompress("/n/Godiva7/jkrick/galfit/4n/fake" + string(k) + "." + string(dist)+ ".fits", /remove_all)
;        newcommand2 = "mv /n/Godiva7/jkrick/galfit/4n/fake.fits " + newimg
        newimg2 = strcompress("/n/Godiva7/jkrick/galfit/4n/nogals" + string(k) + "." + string(dist)+ ".fits", /remove_all)
        newcommand3 = "mv /n/Godiva7/jkrick/galfit/4n/nogals.fits " + newimg2

...
FITS_READ, '/Users/jkrick/umich/icl/A4059/fullblank.fits', blankdata, blankheader

filename = "/Users/jkrick/umich/icl/A4059/fullB"

imagefile = filename + '.fits'
datafile = '/Users/jkrick/umich/icl/A4059/SExtractor.B.cat'
...
satBmag = fltarr(200)
l = 0
OPENR, satlun, '/Users/jkrick/umich/icl/A4059/satstar.txt', /GET_LUN
fits_read, '/Users/jkrick/umich/icl/A4059/fullr.wcs.fits', datawcs, headerwcs
...
;    print, "working on object", o
    ...
    IF(isoarea LT 6.0 OR fwhm LT 3.8 AND true EQ 0) THEN BEGIN  ;2.5
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 3.8 AND fwhm LE 5.2 AND true EQ 0) THEN BEGIN   
...
;    IF (fwhm GT 4.2 AND true EQ 0) THEN BEGIN
    IF (fwhm GT 4.9 AND true EQ 0) THEN BEGIN ;5.1
...
;fits_write, '/Users/jkrick/umich/icl/A4059/mask.block.r.fits',shift(blankdata,-1,-1), blankheader

lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva1/jkrick/A4010/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/Users/jkrick/umich/icl/A4059/fullB.bblock2.fits', data, header

...
FITS_READ, '/Users/jkrick/umich/icl/A4010/fullblank.fits', blankdata, blankheader

filename = "/Users/jkrick/umich/icl/A4010/fullr"

imagefile = filename + '.fits'
datafile = '/Users/jkrick/umich/icl/A4010/SExtractor.r.cat'
;datafile = '/Users/jkrick/A4010/block_obj.r.input'
...
satBmag = fltarr(105)
l = 0
OPENR, satlun, '/Users/jkrick/umich/icl/A4010/satstar.txt', /GET_LUN
fits_read, '/Users/jkrick/umich/icl/A4010/fullr.wcs.fits', datawcs, headerwcs
...
;    IF (fwhm GT 4.2 AND true EQ 0) THEN BEGIN
 ...
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
                    sma = ((1.4*sma)+1.70)/0.879 ; 2.6,2.0,1.4                 
                    smb =  ((1.4*smb)+1.70)/0.879 ;  2.6,2.0,1.4                 
                ENDIF ELSE BEGIN

                    sma =  ((1.6*sma)+1.70)/0.879 ; 3.0,2.3 ,1.6                 
                    smb =  ((1.6*smb)+1.70)/0.879 ; 3.0,2.3,1.6                  
                ENDELSE
 ...
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
        ...
        IF run EQ 2 THEN begin
            IF (sma GT 15.0 OR smb GT 15.0) THEN BEGIN ;big galaxies
                IF(isoarea GT 2000.) THEN BEGIN
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
                    sma =  ((2.6*sma)+1.70)/0.879 ; 2.6,2.0,1.4                 
                    smb =  ((2.6*smb)+1.70)/0.879 ;  2.6,2.0,1.4                 
                ENDIF ELSE BEGIN

                    sma =  ((3.0*sma)+1.70)/0.879 ; 3.0,2.3 ,1.6                 
                    smb =  ((3.0*smb)+1.70)/0.879 ; 3.0,2.3,1.6                  
                ENDELSE
...
;fits_write, '/Users/jkrick/A4010/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header
IF run EQ 0 THEN begin
fits_write, '/Users/jkrick/umich/icl/A4010/mask.block2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A4010/fullr.block2.fits', data, header
endif
IF run EQ 1 THEN begin
fits_write, '/Users/jkrick/umich/icl/A4010/mask.bblock2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A4010/fullr.bblock2.fits', data, header
endif
IF run EQ 2 THEN begin
fits_write, '/Users/jkrick/umich/icl/A4010/mask.vbblock2.r.fits',shift(blankdata,-1,-1), blankheader

fits_write,'/Users/jkrick/umich/icl/A4010/fullr.vbblock2.fits', data, header
endif
;make a profile of what is left
;random center choice
;result = funcprof("/Users/jkrick/A4010/galfit/nogals.s-stars", 492., 503.)
...
;device, filename = '/Users/jkrick/umich/icl/A4010/masksizes.ps', /portrait, $

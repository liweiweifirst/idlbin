...
device, filename = '/n/Godiva3/jkrick/A2556/iclcolor.prof.ps', /portrait, $
  BITS=8, scale_factor=0.9 ;, /color


fits_read, "/n/Godiva3/jkrick/A2556/original/centersmo.r.fits", data, header

;data = data[200:1700,200:1900]


FOR x =0,1900, 1 DO BEGIN
    FOR y=0, 2100, 1 DO BEGIN
...
plotimage, xrange=[50,1850],yrange=[50,2050], bytscl(data, min = 0, max = 7) ,$; bytscl(data, min=1,max=3),$
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
oplot, findgen(238)+240 , findgen(238) -findgen(238)+ 230, thick = 3,color = 245
xyouts,250,280,'200 kpc', color = 245, charthick = 3
xyouts, 1600, 1900, 'A2556', color = 245, charthick = 3
device, /close
set_plot, mydevice

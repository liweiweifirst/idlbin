...
filename = "/Users/jkrick/umich/icl/A2734/fullr"

imagefile = filename + '.fits'
datafile = '/Users/jkrick/umich/icl/A2734/SExtractor.r.cat'
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 2.8 AND fwhm LE 3.9 AND true EQ 0) THEN BEGIN   
        openw, dimlun, "/Users/jkrick/umich/icl/A4010/tvmark.out", /GET_LUN, /append
...
IF run EQ 0 THEN begin
fits_write, '/Users/jkrick/umich/icl/A2734/mask.block2.r.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/Users/jkrick/umich/icl/A2734/fullr.block2.fits', data, header
endif
IF run EQ 1 THEN begin
fits_write, '/Users/jkrick/umich/icl/A2734/mask.bblock2.r.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/Users/jkrick/umich/icl/A2734/fullr.bblock2.fits', data, header
endif
IF run EQ 2 THEN begin
fits_write, '/Users/jkrick/umich/icl/A2734/mask.vbblock2.r.fits',shift(blankdata,-1,-1), blankheader
fits_write,'/Users/jkrick/umich/icl/A2734/fullr.vbblock2.fits', data, header
endif

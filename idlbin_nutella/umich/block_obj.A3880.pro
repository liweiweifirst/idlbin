...
filename = "/n/Godiva6/jkrick/A3880/original/fullr"

imagefile = filename + '.fits'
;datafile = '/n/Godiva3/jkrick/A2556/SExtractor.r.cat'
datafile = '/n/Godiva6/jkrick/A3880/block_obj.r.input'
...
fits_read, '/n/Godiva6/jkrick/A3880/original/fullr.fits', datawcs, headerwcs
...
WHILE (NOT EOF(lun)) DO BEGIN
    ...
    IF xcenter LT 370 AND ycenter GT 3560 THEN true = 1  ;just junk in that corner
...
fits_write, '/n/Godiva6/jkrick/A3880/original/mask.bblock.galr2.fits',shift(blankdata,-1,-1), blankheader

;lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva4/jkrick/A4010/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/n/Godiva6/jkrick/A3880/original/galr.bblock2.fits', data, header

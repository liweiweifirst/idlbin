...
FITS_READ, '/n/Godiva4/jkrick/A114/original/largeblank.fits', blankdata, blankheader

filename = "/n/Godiva4/jkrick/A114/original/larger.div"
print, "working on", filename

imagefile = filename + '.fits'
datafile = '/n/Godiva4/jkrick/A114/SExtractor.r.cat'
;datafile = '/n/Godiva4/jkrick/A114/block_obj.r.input'
newimagefile = filename + '.s.fits'	
outfile = filename + '.bblock.fits'


;run SExtractor on the image to find the objects
commandline = '/n/Godiva7/jkrick/Sex/sex ' + imagefile + " -c /n/Godiva4/jkrick/A114/iclr.sex"
;spawn, commandline
...
;  IF (fwhm GE 2.8 AND fwhm LE 4.2 AND true EQ 0) THEN BEGIN    
    ...
    IF (fwhm GE 2.8 AND fwhm LE 4.0 AND true EQ 0) THEN BEGIN   
        openw, dimlun, "/n/Godiva4/jkrick/A114/tvmark.out", /GET_LUN, /append
...
;    IF (fwhm GT 4.2 AND true EQ 0) THEN BEGIN
 ...
 ;               print, "central galaxy bigger than 2000", xcenter, ycenter, isoarea
        ...
        ;openw, blocklun, "/n/Godiva4/jkrick/A114/galfit/block.log", /GET_LUN, /append
...
;them
j = "j"
OPENR, lunicl, "/n/Godiva4/jkrick/A114/iclr.sex", /GET_LUN
...
fits_write, '/n/Godiva4/jkrick/A114/original/mask.bblock2.galr.fits',shift(blankdata,-1,-1), blankheader

lessstars = data - blankdata   ;;;minus
;fits_write, '/n/Godiva4/jkrick/A114/galfit/nogals.s-stars.fits', shift(lessstars, -1, -1), header

fits_write,'/n/Godiva4/jkrick/A114/original/galr.bblock2.fits', data, header

;make a profile of what is left
;random center choice
;result = funcprof("/n/Godiva4/jkrick/A114/galfit/nogals.s-stars", 492., 503.)

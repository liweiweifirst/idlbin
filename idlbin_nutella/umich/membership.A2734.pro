...
OPENR, lun1, "/n/Godiva4/jkrick/A2734/cmd/2df.txt", /GET_LUN, ERROR = err
...
WHILE (NOT EOF(lun1)) DO BEGIN
    ...
    IF (z GT 0.05) AND (z LT 0.08) THEN BEGIN ;member
...
;----------------------------------------------------------------------
ps_open, file = "/n/Godiva4/jkrick/A2734/membership.ps", /portrait, /color, ysize = 7

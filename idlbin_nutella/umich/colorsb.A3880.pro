...
device, filename = '/n/Godiva6/jkrick/A3880/iclcolor.ps', /portrait, $
  BITS=8, scale_factor=0.9 ;, /color


fits_read, "/n/Godiva6/jkrick/A3880/original/centersmo.r.fits", data, header

;data = data[200:1700,200:1900]


FOR x =700,2700, 1 DO BEGIN
    FOR y=900, 3600, 1 DO BEGIN
...
plotimage, xrange=[700,2700],yrange=[1100,3400], bytscl(data, min = 0, max = 7) ,$; bytscl(data, min=1,max=3),$
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
oplot, findgen(366)+850 , findgen(366) -findgen(366)+ 1250, thick = 3,color = 245
xyouts,870,1300,'200 kpc', color = 245, charthick = 3
xyouts, 750, 3250, 'A3880', color = 245, charthick = 3
device, /close
set_plot, mydevice
;
;

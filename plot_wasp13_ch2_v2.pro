...
timearr = [AORwasp13[1].timearr]
fluxarr = [ AORwasp13[1].flux]
fluxerrarr = [ AORwasp13[1].fluxerr]
corrfluxarr = [ AORwasp13[1].corrflux]
corrfluxerrarr = [AORwasp13[1].corrfluxerr]
xarr = [ AORwasp13[1].xcen]
yarr = [AORwasp13[1].ycen]
bkgd = [ AORwasp13[1].bkgd]
bmjd = [ AORwasp13[1].bmjdarr]

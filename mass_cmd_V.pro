...
;ps_start, filename = "/Users/jkrick/Virgo/irac/mass_cmd.ps"
  ps_open, filename='/Users/jkrick/Virgo/irac/mass_cmd_V.ps',/portrait,/square,/color
...
;bc03
    ...
    plot, findgen(10), findgen(10), xrange = [13, 17], yrange = [0.5, 1.1], ystyle = 1,/nodata, xtitle = 'V (AB)', ytitle = 'B - V (AB)', thick = 3, charthick = 3,xthick = 3, ythick = 3
...
;       print, 'ch1arr', ch1arr
 ...
 ;         print, 'ch1arr(b)', ch1arr(b)
          oplot, varr(b), barr(b)-varr(b), thick = 3
          if a gt 2E8 then xyouts, varr(b(8)), barr(b(8)) - varr(b(8)),   string(a, format = '(E10.1)'), orientation = 45, charthick = 3

       endfor
       
           for a = 5E8, 4.9E9,5E8 do begin
              b = where(massarr eq a)
;              print, 'mass', massarr(b)
;              print, 'ch1arr(b)', ch1arr(b)
              oplot, varr(b), barr(b)-varr(b), thick = 3
...
;          modelname =  strmid(filename(m), 65,19) + string(bc03age(bcnj))
              xyouts, varr(b(8)), barr(b(8)) - varr(b(8)),   string(a, format = '(E10.1)'), orientation = 45, charthick = 3
...
print, x_ch1, 'x_ch1'
xerr = 0.65; (making this up)
y_bv = 0.9-0.12 ; include conversion from Vega to AB
yerr = 0.15
x_v = 14.5
x_err = 0.5
oploterror, x_v,y_bv, x_err, yerr, errthick = 3, psym = 2, thick = 3
...
x_ch1 = flux_to_magab(erg)   ;in  magab
print, 'x', x_ch1
xerr = 0.8; (making this up)
y_bv = 1.0-0.12 ; include conversion from Vega to AB
yerr = 0.2
;oploterror, x_ch1,y_bv, xerr, yerr, errthick = 3, psym = 2, thick = 3
